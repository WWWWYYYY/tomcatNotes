...
public final class Bootstrap {
   ...
   /**
     ...
     * scripts.
     * JVM参数 -Dcatalina.home="/Users/mac/PROJECT/WORKSPACE_GITHUB/tomcatNotes/catalina-home" 在设置参数的时候需要注意catalina-home在哪里就设置到哪里
     *
     * 创建catalina-home目录，目录下包含一下目录，都来自tomcat软件解压后的文件，将tomcat软件解压后的目录下的相关文件或者文件夹复制到catalina-home目录下
     * catalina-home
     *      -bin
     *      -conf
     *      -lib
